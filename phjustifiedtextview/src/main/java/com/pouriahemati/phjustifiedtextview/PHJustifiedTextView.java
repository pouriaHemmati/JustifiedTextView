package com.pouriahemati.phjustifiedtextview;
...
/**
 * author pouria hemati
 */
public class PHJustifiedTextView extends View {
	...
	public PHJustifiedTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		constructor(context,attrs);
	}
	public PHJustifiedTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		constructor(context,attrs);
	}
	public PHJustifiedTextView(Context context) {
		super(context);
...
//			setText(XmlToClassAttribHandler.GetAttributeStringValue(mContext, attrs, namespace, key, ""));
	...
	private void setLineHeight(TextPaint textPaint) {
		...
		String sampleStr="دریاهای آرام ملوانان ماهر نمی سازد";
